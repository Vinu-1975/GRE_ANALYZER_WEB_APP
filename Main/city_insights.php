...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="./city_insights.php" style="background-color: white;">
    ...
    <section class="home-section">
        <nav>
            <div class="sidebar-button">
                ...
                <span class="dashboard">City Insights</span>
            </div>
        ...
        <div class="home-content">
            <div class="city-insights-content">
                <div class="title">
                    <h1>City Insights</h1>
                </div>
                <div class="description">
                    <p>
                        Below are the details about the number of test-takers and average percentile from all
                        Metropolitan Cities of this year
                    </p>
                </div>
                <div>
                    <?php
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <?php
                            $sql = 'select * from r7 order by city_id';
                            if ($result = mysqli_query($conn, $sql)) {
                                while ($row = $result->fetch_assoc()) {
                                    $id = $row['city_id'];
                                    $cname = $row['city_name'];
                                    $cn = $row['no_of_applicants'];
                                    $cavg = $row['avg_percentile'];
